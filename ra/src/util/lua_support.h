...
public:
    ...
    {
        m_table.new_usertype<RegistrantType>(name, "new", initializer, args...);
        sol::table table = m_table[name];
    ...
    {
        m_table.new_usertype<RegistrantType>(name, "new", initializer, sol::base_classes, bases, args...);
        sol::table table = m_table[name];
        return LuaTable{ std::move(table) };
    }
    ...
    {
        return LuaTable{ std::move(m_table.create_named(name)) };
    }
...
public:
    ...
    {
        initialize();
        m_lua_state->new_usertype<RegistrantType>(name, "new", initializer, args...);
    ...
    {
        initialize();
        m_lua_state->new_usertype<RegistrantType>(name, "new", initializer, sol::base_classes, bases, args...);
        sol::table table = (*m_lua_state)[name];
        return LuaTable{ std::move(table) };
    }
