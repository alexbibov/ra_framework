...
using namespace ra::util::misc;

Optional<std::string> ra::util::misc::readAsciiTextFromSourceFile(std::string const& source_file)
{
...
std::string ra::util::misc::wstringToAsciiString(std::wstring const& wstr)
{
...
int8_t ra::util::misc::getFirstHighBit(uint64_t mask)
{
    int8_t rv{ -1 };
...
ra::util::StaticVector<uint8_t, 64U> ra::util::misc::getSetBits(uint64_t mask)
{
...
bool ra::util::misc::doesFileExist(std::string const& file_path)
{
