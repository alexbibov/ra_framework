...
#include "datetime.h"
#include "../ox_wrapper/exception.h"
...
"(" << optix_error_string << ")"; \
ox_wrapper::util::Log::retrieve()->out(out_message.str(), ox_wrapper::util::LogMessageType::error);\
} \
}
...
char const* optix_error_string{ nullptr }; \
rtContextGetErrorString(optix_context, optix_error_log_rv, &optix_error_string); \
throw ox_wrapper::OxException{ optix_error_string, __FILE__, __FUNCTION__, __LINE__ }; \
}\
}
